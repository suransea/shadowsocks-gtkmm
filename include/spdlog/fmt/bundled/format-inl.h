...
FMT_FUNC void grisu2_gen_digits(
    ...
    while (exp > 0) {
        ...
        // one per iteration.
        switch (exp) {
            case 10: digit = hi / 1000000000;
                hi %= 1000000000;
                break;
            case 9: digit = hi / 100000000;
                hi %= 100000000;
                break;
            case 8: digit = hi / 10000000;
                hi %= 10000000;
                break;
            case 7: digit = hi / 1000000;
                hi %= 1000000;
                break;
            case 6: digit = hi / 100000;
                hi %= 100000;
                break;
            case 5: digit = hi / 10000;
                hi %= 10000;
                break;
            case 4: digit = hi / 1000;
                hi %= 1000;
                break;
            case 3: digit = hi / 100;
                hi %= 100;
...
FMT_FUNC void grisu2_format(double value, char *buffer, size_t &size, char type,
    ...
    switch (type) {
        ...
        case 'e':
        case 'E':format_exp_notation(buffer, size, dec_exp, precision, type == 'E');
            return;
    }
